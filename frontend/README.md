# Frontend - StacksFund Service Verification

Next.js web application for interacting with the StacksFund service verification system on Stacks blockchain.
...
NEXT_PUBLIC_API_URL=https://api.stacksfund.com
```
