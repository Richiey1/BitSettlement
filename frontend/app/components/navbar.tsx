...
import { ChevronDown, LogOut, User, Rocket, Vote, CheckSquare, Home } from "lucide-react";
    ...
    <nav className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 h-16">
        <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
          <Image src="/logo.svg" alt="StacksFund" width={32} height={32} className="transition-transform group-hover:scale-110 rounded-lg" />
          <span className="text-lg font-black tracking-tight text-foreground">
            Stacks<span className="text-primary">Fund</span>
          </span>
        </Link>
